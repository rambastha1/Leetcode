...
use http protocol without any port specified. For example, the urls http://leetcode.com/problems and http://leetcode.com/contest 
...
class Solution {
    public List<String> crawl(String startUrl, HtmlParser htmlParser) {
    	...
    	while(!q.isEmpty()) {
    		String curr = q.poll();
    		for(String str : htmlParser.getUrls(curr)) {
    			if(str.contains(host) && !visited.contains(str)) {
    				q.offer(str);
    				visited.add(str);
    			}
    		}
...
public class Main {
	public static void main(String[] args) {
		String str = "http://news.yahoo.com/news/topics/";
