 ...
 * The only thing you are allowed to do is to ask questions like: â€œHi, A. Do you know B?â€� 
 ...
 * Return the celebrityâ€™s label if there is a celebrity in the party. 
...
public class Main {
	...
	public static void main(String[] args) {
		int [][]matrix = {{0, 0, 1, 0}, 
						  ...
						  {0, 0, 1, 0} }; 
		int n = 4;
		System.out.println(new Solution().findCelebrity(n));
	}
}
